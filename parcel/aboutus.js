...
var inner_page = require('/src/inner_page.png');
var back = require('/src/back.png');
var cover = require('/src/cover.png');
var count = 0;
window.goal = function goal(){
    $("#page_01_goal").show();
}

window.why = function why(){
    $("#page_01_why").show();
}

window.how = function how(){
    $("#page_01_how").show();
}
...
window.photo1 = function photo1(){
    $("#page_02_01").show();
}

window.photo2 = function photo2(){
    $("#page_02_02").show();
}

window.photo3 = function photo3(){
    $("#page_03_01").show();
}

window.photo4 = function photo4(){
    $("#page_03_02").show();
}

window.photo5 = function photo5(){
    $("#page_04_01").show();
}

window.photo6 = function photo6(){
    $("#page_04_02").show();
}

window.photo7 = function photo7(){
    $("#page_05_01").show();
}
...
window.next = function next(){
    ...
    switch(count){
        case 0:
            ...
            $("#previous").show();
            $("#page_01").show();
            document.getElementById("cover").style.backgroundImage = 'url(' +inner_page+ ')';
			//document.getElementById("cover").style.backgroundImage = 'url("https://i.imgur.com/h4ApVPT.png")';
        ...
        case 6:
			...
			document.getElementById("cover").style.backgroundImage = 'url(' +back+ ')';
